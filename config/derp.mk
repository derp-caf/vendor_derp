...
# Derp-CAF versions.
CAF_REVISION := LA.UM.7.2.r1-08700-sdm660.0
DERP_VERSION_FLAVOUR = HORIZON
DERP_VERSION_CODENAME := 0.04
PLATFORM_VERSION_FLAVOUR := Pie

# Set all versions
DERP_VERSION := DerpCAF-v$(DERP_VERSION_CODENAME)-$(DERP_VERSION_FLAVOUR)-$(DERP_BUILD_TYPE)$(DERP_POSTFIX)
DERP_MOD_VERSION := DerpCAF-v$(DERP_VERSION_CODENAME)-$(DERP_VERSION_FLAVOUR)-$(DERP_BUILD)-$(DERP_BUILD_TYPE)$(DERP_POSTFIX)
